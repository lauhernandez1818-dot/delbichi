...
const FooterParallax: React.FC = () => {
  ...
  return (
    <div ref={containerRef} id="contacto" className="relative w-full">
      <footer
        ref={footerRef}
        className="site-footer relative flex h-auto w-full flex-col overflow-x-hidden px-6 pt-16 md:px-12 md:pt-20 lg:px-20 will-change-transform"
        style={{
          background: `
      ...
      >
        ...
        <div className="footer-reveal my-auto flex w-full flex-col items-center justify-center gap-6 text-center md:gap-8">
        ...
        <div className="footer-reveal footer-social-row mt-16 grid w-full grid-cols-1 items-end gap-10 border-t border-white/10 pt-8 md:mt-20 lg:grid-cols-2 lg:gap-8">
          {/* Tech/Mono Info */}
          ...
          {/* Social Links */}
          <div className="footer-social-links flex flex-row flex-wrap items-center gap-3 lg:justify-end">
            <a
              href={INSTAGRAM_URL}
              target="_blank"
              rel="noopener noreferrer"
